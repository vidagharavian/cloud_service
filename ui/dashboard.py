...
class DashboardUi(QtWidgets.QMainWindow):
    ...
    def ticketsButtonPressed(self):
        from ticket_list import TicketListUi
    ...
    def increaseButtonPressed(self):
        from increase_wallet import IncreaseCreditUi
